...
<body>
  ...
  const loginWithGoogle = async (): Promise<{ success: boolean; message: string }> => {
    try {
      ...
      await firebaseModule.firebaseBootPromise;
      const firebaseAuth = firebaseModule.auth;
      if (!firebaseModule.getIsFirebaseConfigured() || !firebaseAuth) {
        return { success: false, message: 'Google Sign-In requires Firebase to be configured. Run the setup wizard and save valid Firebase Web App credentials first.' };
      }
